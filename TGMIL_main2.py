...
parser.add_argument('--results_dir', default='/remote-home/maojiahui/CLAM/necrosis results/MILFusion',
                    help='results directory (default: ./results)')
parser.add_argument('--split_dir', type=str, default='task_SY_low_vs_high_grading',
...
parser.add_argument('--model_type', type=str,
                    choices=['MILFusion', 'HECTOR', 'WiKG', 'MHIM', 'CLAM_sb', 'CLAM_mb'], default='MILFusion',
                    help='type of model')

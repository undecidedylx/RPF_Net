...
from utils.core_utils_6_TGMIL_0722 import train
...
parser.add_argument('--results_dir', default='/remote-home/maojiahui/CLAM/uiss results/TGMIL_SY(ct+wsi)',
...
parser.add_argument('--model_type', type=str,
                    choices=['clam_sb', 'clam_mb', 'mil', 'transMIL_mb', 'dsmil', 'GAT', 'transGAT',
                             'GraphTransformer'], default='transGAT',
...
if args.task == 'task_SY_low_vs_high':
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path='/remote-home/maojiahui/CLAM/tables/UISS更新后/sy+gy.csv',

...
class Matrix_Logger(object):
    ...
    def matrix(self,i,str):
        ...
        # plt.show()
        save_path = 'remote-home/sunxinhuan/PycharmProject/data/TGMIL_8_9_返修/SZG_results/results_0/dsmil_1_28_2/matrix'
...
def train(datasets, cur, args):
    ...
    for epoch in range(args.max_epochs):
        if args.model_type in ['clam_sb', 'clam_mb','transMIL_mb','dsmil','transGAT','transMIL'] and not args.no_inst_cluster:
...
def train_loop_clam(epoch, model, loader, optimizer, n_classes, bag_weight, writer = None, loss_fn = None):
    ...
    for batch_idx, (data, label) in enumerate(loader):
        ...
        avg_data_size += data.size(0)
        if batch_idx == 719:
            print('前两百平均的包大小：',avg_data_size//batch_idx)

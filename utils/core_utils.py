...
from models.transGAT_model_1_Fusion import vit_base_patch16_224_in21k as TransGATMIL
...
class Matrix_Logger(object):
    ...
    def matrix(self,i,str):
        ...
        # plt.show()
        save_path = '/remote-home/sunxinhuan/PycharmProject/data/maojiahui/results/clam_sb_1228/matrix'
...
def train(datasets, cur, args):
    ...
    # test_error, test_auc, test_precision, test_racall, test_F1 = 0, 0, 0, 0, 0

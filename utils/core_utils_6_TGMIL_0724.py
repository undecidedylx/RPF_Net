...
from models.transGAT_model_1_0724 import ADJ
from models.transGAT_model_1_0724 import vit_base_patch16_224_in21k as TransGATMIL
...
class Matrix_Logger(object):
    ...
    def matrix(self,i,str):
        ...
        # plt.show()
        save_path = '/remote-home/sunxinhuan/PycharmProject/data/TGMIL_8_9_返修/reuslts_3_0/TGMIL_3×_28_2/matrix'

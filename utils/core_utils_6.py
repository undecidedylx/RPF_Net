...
class Matrix_Logger(object):
    ...
    def matrix(self,i,str):
        ...
        # plt.show()
        save_path = '/remote-home/sunxinhuan/PycharmProject/data/GY_SY_mutil_slice_ccRCC_23_1009/results/GY_SY_TGMIL_1023_1/matrix'
...
def train(datasets, cur, args):
    ...
    if args.bag_loss == 'svm':
        ...
        weight = torch.FloatTensor([0.3, 0.7]).to(device)  # 权重设置，根据统计各类别切片数量

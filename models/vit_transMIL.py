...
class dsmil(nn.Module):
    def __init__(self,input_size,output_class,dropout_v = 0.0,nonlinear=True):
        ...
        self.k_sample = 3
        self.fc = nn.Sequential(nn.Linear(input_size,output_class))
...
class VisionTransformer(nn.Module):
    ...
    def relocate(self):
        ...
        # self.dsmil = self.dsmil.to(device)
    ...
    def forward(self, **kwargs):
        ...
        if x.shape[0] >= 10000:
            # x = x[:10000,:]
            sample_num = 10000
            sample_list = [i for i in range(len(x))]
        ...
        x = self.forward_features(x1) # [1,N+1,512]
...
if __name__ == "__main__":
    ...
    model = Block(dim=1024, num_heads=8).cuda()
    # model = CBAM(planes=1024).cuda()
    print(model.eval())

...
parser.add_argument('--data_root_dir', default='/remote-home/maojiahui/CLAM/patches/',type=str,
                    help='data directory')
...
parser.add_argument('--results_dir', default='/remote-home/maojiahui/CLAM/results/TGMIL_SY_GY(GAT+tran)', help='results directory (default: ./results)')
...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'clam_mb', 'mil','transMIL_mb','dsmil','GAT','transGAT','GraphTransformer'], default='transGAT',
...
parser.add_argument('--task', type=str, choices=['task_1_low_vs_high',  'task_2_tumor_subtyping'],default='task_SY_GY_low_vs_high')
...
if args.task == 'task_SY_GY_low_vs_high':
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path = '/remote-home/maojiahui/CLAM/tables/three sources/SY+GY(lwc).csv',
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = '/remote-home/maojiahui/CLAM/SSIGN.csv',
                            data_dir= os.path.join(args.data_root_dir),
                            shuffle = False,
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'normal_tissue':0, 'lowtumor_tissue':1,'hightumor_tissue':2 },
                            patient_strat= False,
                            ignore=[])
...
if args.split_dir is None:
    args.split_dir = os.path.join('/remote-home/maojiahui/CLAM/splits', args.task+'_{}'.format(int(args.label_frac*100)))
else:

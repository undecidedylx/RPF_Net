...
parser.add_argument('--results_dir', default='/remote-home/maojiahui/CLAM/uiss results/OGM-GE_SY',
...
parser.add_argument('--model_type', type=str,
                    choices=['MILFusion', 'HECTOR', 'WiKG', 'MHIM', 'CLAM_sb', 'CLAM_mb'], default='OGM-GE',
                    help='type of model')
